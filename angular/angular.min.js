...
(function(N, Q, w) {
    ...
    function oa(a, b) {
        ...
        if (d == typeof b &&
            ...
            if (L(a)) {
                ...
                for (c in b)
                    if (!(c in d) && "$" !== c.charAt(0) && A(b[c]) && !H(b[c])) return !1;
                return !0
            }
        return !1
    }
    ...
    function Bc(a, b) {
        ...
        var e = {},
            f = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/,
            g = /(([\w\-]+)(?:\:([^;]+))?;?)/,
            h = Yd("ngSrc,ngSrcset,src,srcset"),
            k = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/,
            l = /^(on[a-z]+|formaction)$/,
            m = X();
            ...
            D(b) ? (c(b), sb(d, "directiveFactory"), e.hasOwnProperty(b) || (e[b] = [], a.factory(b + "Directive", ["$injector", "$exceptionHandler", function(a, c) {
                ...
                p(e[b], function(e, f) {
                    try {
                        ...
                        H(g) ? g = {
                            compile: ia(g)
                        } : !g.compile && g.link && (g.compile = ia(g.link));
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function(a, b, c, m, t, u, s, M,
            ...
            function Aa(a, b, c, d, e) {
                ...
                switch (a.nodeType) {
                    case 1:
                        ...
                        I(a) && (a = a.animVal);
                        if (D(a) && "" !== a)
                            for (; k = g.exec(a);) l = ua(k[2]), N(b, l, "C", d, e) && (c[l] = Z(k[3])), a = a.substr(k.index + k[0].length);
                        break;
                    case Na:
                        if (11 === za)
            ...
            function O(a, b, d, e, f, g, h, k, l) {
                ...
                for (var q = -Number.MAX_VALUE,
                    ...
                    K = s.name;
                    if (!va && (s.replace && (s.templateUrl || s.template) || s.transclude &&
                            !s.$$tlb)) {
                        for (E = Q + 1; va = a[E++];)
                            if (va.transclude && !va.$$tlb || va.replace && (va.templateUrl || va.template)) {
                                N = !0;
                                break
                            }
                        va = !0
                    ...
                    if (E = s.transclude)
                        if (F = !0, s.$$tlb || (aa("transclusion", B, s, P), B = s), "element" == E) M = !0, q = s.priority, ca = P, P = d.$$element = G(R.$$createComment(K, d[K])), b = P[0], ga(f, ya.call(ca, 0), b), z = Yb(N, ca, e, q, g && g.name, {
                    ...
                    if (s.template)
                        if ($ = !0, aa("template", J, s, P), J = s, E = H(s.template) ? s.template(P, d) : s.template, E = ra(E), s.replace) {
                            g = s;
                            ca = Tb.test(E) ?
            ...
            function Y(a, b, c, d, e, f, g, h) {
                var k = [],
                    ...
                    J = H(u.templateUrl) ? u.templateUrl(b, c) : u.templateUrl,
            ...
            T.prototype = {
                ...
                $set: function(a, b, d, e) {
                    ...
                    f = pa(this.$$element);
                    if ("a" === f && ("href" === a || "xlinkHref" === a) || "img" === f && "src" === a) this[a] = b = J(b, "src" === a);
                    else if ("img" === f && "srcset" === a) {
                        for (var f = "", g = Z(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(g) ? k : /(,)/, g = g.split(k), k = Math.floor(g.length / 2), l = 0; l < k; l++) var m = 2 * l,
                            f = f + J(Z(g[m]), !0),
                            f = f + (" " + Z(g[m + 1]));
                        g = Z(g[2 * l]).split(/\s/);
                        f += J(Z(g[0]), !0);
        ...
        this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(e, f, g, h, k, l) {
            function m(b) {
                ...
                f.headers = function(b) {
                    var c = a.headers,
                        d = S({}, b.headers),
                        f, g, h, c = S({}, c.common, c[E(b.method)]);
                    a: for (f in c) {
                        g = E(f);
                        for (h in d)
                            if (E(h) === g) continue a;
                ...
                var g = [function(b) {
                        var d = b.headers,
                            e = cd(b.data, bd(d), w, b.transformRequest);
                        v(e) && p(d,
                            function(a, b) {
            ...
            function n(c, d) {
                ...
                var C = k.defer(),
                    J = C.promise,
                    T, F, $ = c.headers,
                    R = y(c.url, c.paramSerializer(c.params));
        ...
        function f(a, b, d) {
            ...
            m = function(a) {
                ...
                a && ("load" !== a.type || c[b].called || (a = {
                    type: "error"
                }), B = a.type, g = "error" === a.type ? 404 : 200);
                d && d(g, B)
            };
    ...
    function ff() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function(d, c, e) {
            ...
            function k(f, k,
                ...
                u = f.length;
                for (var F = [], $ = []; C < u;)
                    if (-1 != (s = f.indexOf(a, C)) && -1 != (p = f.indexOf(b, s + l))) C !== s && F.push(g(f.substring(C, s))), C = f.substring(s +
                        l, p), J.push(C), T.push(d(C, y)), C = p + m, $.push(F.length), F.push("");
                    else {
    ...
    function gf() {
        this.$get = ["$rootScope", "$window", "$q", "$$q", "$browser", function(a, b, d, c, e) {
            function f(f, k, l, m) {
                ...
                var y = 4 < arguments.length,
                    B = y ? ya.call(arguments, 4) : [],
                    p = b.setInterval,
                    x = b.clearInterval,
                    q = 0,
                    t = A(m) && !m,
                ...
                m.prototype = {
                    ...
                    $digest: function() {
                        ...
                        do {
                            ...
                            a: do {
                                if (y = M.$$watchers)
                                    for (q = y.length; q--;) try {
                                        if (a = y[q])
                                            if (m = a.get, (g = m(M)) !== (k = a.last) &&
                                                !(a.eq ? oa(g, k) : "number" === typeof g && "number" === typeof k && isNaN(g) && isNaN(k))) B = !0, c = a, a.last = a.eq ? qa(g, null) : g, l = a.fn, l(g, k === r ? g : k, M), 5 > p && (A = 4 - p, w[A] || (w[A] = []), w[A].push({
                                ...
                                if (!(y = M.$$watchersCount && M.$$childHead || M !== this && M.$$nextSibling))
                                    for (; M !== this && !(y = M.$$nextSibling);) M = M.$parent
                            } while (M = y);
                    ...
                    $on: function(a, b) {
                        ...
                        var e = this;
                        return function() {
                            var d = c.indexOf(b); - 1 !== d && (c[d] = null, B(e, 1, a))
                        }
                    },
                    $emit: function(a, b) {
                        var c = [],
    ...
    function vf() {
        this.$get = ["$window", "$document", function(a, b) {
            var d = {},
                c = da((/android (\d+)/.exec(E((a.navigator || {}).userAgent)) || [])[1]),
    ...
    function vd(a) {
        ...
        return function() {
            ...
            a = d.cookie || "";
            if (a !== e)
                for (e = a, a = e.split("; "), c = {}, h = 0; h < a.length; h++) g = a[h], k = g.indexOf("="), 0 < k && (l = b(g.substring(0, k)), v(c[l]) && (c[l] = b(g.substring(k + 1))));
            return c
        }
    }
    ...
    function Ka(a, b, d, c, e) {
        ...
        switch (f) {
            case "object":
                ...
                if ("object" === g) {
                    for (h in b)
                        if (e = b[h], !H(e) && !v(e) && (f = "$" === h, !Ka(f ? a : a[h], e, d, f, f))) return !1;
                    return !0
                }
                return d(a, b);
            case "function":
    ...
    function sg(a) {
        var b = 0,
            d, c, e, f, g; - 1 < (c = a.indexOf(Bd)) && (a = a.replace(Bd, ""));
    ...
    function mb(a, b, d, c) {
        return function(e, f, g, h, k, l, m) {
            ...
            Id(e, f, g, h);
            lb(e, f, g, h, k, l);
            var p = h && h.$options && h.$options.timezone,
                r;
            h.$$parserName = a;
    ...
    var L = Array.isArray,
        ...
        rb = function() {
            ...
            var a, b, d = Oa.length,
                c, e;
            for (b = 0; b < d; ++b)
                if (c = Oa[b], a = Q.querySelector("[" + c.replace(":", "\\:") + "jq]")) {
                    e =
                        a.getAttribute(c + "jq");
                    break
                }
    ...
    var Ff = /([\:\-\_]+(.))/g,
        ...
        Tb = /<|&#?\w+;/,
        Hf = /<([\w:-]+)/,
        If = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,
        ka = {
    ...
    p({
        ...
        attr: function(a, b, d) {
            ...
            else if (a.getAttribute) return a = a.getAttribute(b, 2), null === a ? w : a
        },
        prop: function(a, b, d) {
            if (A(d)) a[b] = d;
            else return a[b]
            ...
            search: function(a, b) {
                switch (arguments.length) {
                    case 0:
                        return this.$$search;
                    case 1:
                        if (D(a) || W(a)) a = a.toString(), this.$$search = wc(a);
                        else if (I(a)) a = qa(a, {}), p(a, function(b, c) {
                            null == b && delete a[c]
                        }), this.$$search = a;
        ...
        readNumber: function() {
            for (var a = "", b = this.index; this.index < this.text.length;) {
                ...
                if ("." == d || this.isNumber(d)) a += d;
                    ...
                    else if (this.isExpOperator(d) && c &&
                        this.isNumber(c) && "e" == a.charAt(a.length - 1)) a += d;
    ...
    pd.prototype = {
        ...
        recurse: function(a, b, d, c, e, f) {
            ...
            c = c || z;
            if (!f &&
                A(a.watchId)) b = b || this.nextId(), this.if_("i", this.lazyAssign(b, this.computedMember("i", a.watchId)), this.lazyRecurse(a, b, d, c, e, !0));
            else switch (a.type) {
                case r.Program:
                    ...
                    k.recurse(a.object, g, w, function() {
                        k.if_(k.notNull(g), function() {
                            ...
                            if (a.computed) h = k.nextId(), k.recurse(a.property, h), k.getStringValue(h), k.addEnsureSafeMemberName(h), e && 1 !== e && k.if_(k.not(k.computedMember(g, h)), k.lazyAssign(k.computedMember(g, h), "{}")),
                                m = k.ensureSafeObject(k.computedMember(g, h)), k.assign(b, m), d && (d.computed = !0, d.name = h);
                            else {
                                Va(a.property.name);
    ...
    var Td = {
            ...
            checkbox: function(a, b, d, c, e, f, g, h) {
                var k = Jd(h, a, "ngTrueValue", d.ngTrueValue, !0),
                    l = Jd(h, a, "ngFalseValue", d.ngFalseValue, !1);
                b.on("click", function(a) {
    ...
    var Ae = ["$animate", "$compile", function(a,
        ...
        Le = ["$compile", "$parse", function(a, b) {
            ...
            var c = Q.createElement("option"),
                e = Q.createElement("optgroup");
            return {
                restrict: "A",
                terminal: !0,
                    ...
                    post: function(b, g, h, k) {
                        ...
                        function r(a) {
                            var b = t && t[0],
                                c = C && C[0];
                            if (b || c)
                                for (; a && (a === b || a === c || 8 === a.nodeType || "option" === pa(a) && "" === a.value);) a = a.nextSibling;
                            return a
                        }
                        ...
                        var v = k[0],
                            ...
                            t;
                        k = 0;
                        for (var u = g.children(), s = u.length; k < s; k++)
                            if ("" === u[k].value) {
                                t = u.eq(k);
                                break
                            }
                        ...
                        q ? (x.$isEmpty = function(a) {
                            ...
                            b && !b.disabled ? (g[0].value !== b.selectValue && (C.remove(), z || t.remove(), g[0].value = b.selectValue, b.element.selected = !0), b.element.setAttribute("selected", "selected")) : null === a || z ? (C.remove(), z || g.prepend(t), g.val(""), t.prop("selected", !0), t.attr("selected", !0)) : (z || t.remove(), g.prepend(C), g.val("?"), C.prop("selected", !0), C.attr("selected", !0))
                        }, v.readValue = function() {
                    ...
                    return function(a, d, f, g, l) {
                        ...
                        a.$watchCollection(n, function(f) {
                            ...
                            if (Ca(f)) H = f, n = t || u;
                                ...
                                for (I in n = t || s, H = [], f) sa.call(f, I) && "$" !== I.charAt(0) && H.push(I);
                            z = H.length;
                            I = Array(z);
                            for (g = 0; g < z; g++)
                                if (D = f === H ? g : H[g], G = f[D], F = n(D, G, g), m[F]) E = m[F], delete m[F], B[F] = E, I[g] = E;
                                else {
                            ...
                            for (v in m) {
                                ...
                                b.leave(F);
                                if (F[0].parentNode)
                                    for (g = 0, n = F.length; g <
                                        n; g++) F[g].$$NG_REMOVED = !0;
                                E.scope.$destroy()
                            }
                            for (g = 0; g < z; g++)
                                if (D = f === H ? g : H[g], G = f[D], E = I[g], E.scope) {
                                    v = q;
